...
class newPayment(Resource):
    ...
    def post(self):
        ...
        #                     help="This field cannot be blank."
        #                     )
        # parser.add_argument('CHECKSUMHASH',
        #                     type=str,
        #                     required=True,
        #                     help="This field cannot be blank."
        #                     )
        # parser.add_argument('TXNAMOUNT',
        #                     type=str,
        #                     required=True,
        #                     help="This field cannot be blank."
        #                     )
        ...
        # valid = PaytmChecksum.verifySignature(json.dumps(paytmParams['body']), key, data["CHECKSUMHASH"])

        # order = OrdersModel.find_by_orderid(data['ORDERID'])
        # if not order:
        #     return {'message': 'Order not found.'}
        
        # print(order.checksumhash)
